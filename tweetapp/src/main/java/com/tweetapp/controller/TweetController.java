...
public class TweetController {
    ...
    public Boolean addUserTweet(@PathVariable("loginId") String loginId, @RequestBody String tweet) {
        log.info("adding tweet");
        tweetSercice.addUserTweet(loginId, tweet);
    ...
    public Tweet updateTweet(@PathVariable("loginId") String loginId, @PathVariable("tweetId") String tweetId,
        ...
        Tweet tweetList = tweetSercice.updateTweet(tweetId, tweet);
        return tweetList;
    }
